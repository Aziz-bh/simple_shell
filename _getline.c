...
/**
 * _getline - Reads one line from the input and processes it for execution.
...
int _getline(data_of_program *data)
{
     ...
     * or if logical operators should be evaluated.
     */
        ...
        (array_operators[0] == '|' && errno == 0))
    {
        ...
        /* Split lines by '\n' or ';' and handle logical operators. */
        i = 0;
        do {
...
/**
 * check_logic_ops - Checks and splits for '&&' and '||' operators in commands.
